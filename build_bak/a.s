...
my_div:
	...
	mov BP, SP
	sub SP, 52
	.file 1 "/workspaces/Artfuscator/elvm/libc/_builtin.h"
	.loc 1 35 0
	# }
	.loc 1 11 0
	#   unsigned int r[24];
...
print_str:
	...
	mov SP, D
	mov BP, SP
	.file 2 "/workspaces/Artfuscator/elvm/libc/_raw_print.h"
	.loc 2 9 0
	#     putchar(*p);
	.L30:
	.loc 1 164 0
...
isspace:
	...
	mov SP, D
	mov BP, SP
	.file 3 "/workspaces/Artfuscator/elvm/libc/ctype.h"
	.loc 3 5 0
	#           c == '\t' || c == '\v' || c == ' ');
	.loc 2 44 0
	# }
...
abort:
	...
	mov SP, D
	mov BP, SP
	.file 4 "/workspaces/Artfuscator/elvm/libc/stdlib.h"
	.loc 4 22 0
	# }
	mov A, 1
	mov D, SP
...
memset:
	...
	mov BP, SP
	sub SP, 1
	.file 5 "/workspaces/Artfuscator/elvm/libc/string.h"
	.loc 5 13 0
	# }
	.loc 5 9 0
	#   for (i = 0; i < n; i++) {
...
puts:
	...
	mov SP, D
	mov BP, SP
	.file 6 "/workspaces/Artfuscator/elvm/libc/stdio.h"
	.loc 6 20 0
	# }
	.loc 6 19 0
	#   putchar('\n');
